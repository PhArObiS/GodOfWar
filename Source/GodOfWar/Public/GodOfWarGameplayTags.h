...
namespace GodOfWarGameplayTags
{
	...
	GODOFWAR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_HitReact_Front);
	GODOFWAR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_HitReact_Left);
	GODOFWAR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_HitReact_Right);
	GODOFWAR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_HitReact_Back);
